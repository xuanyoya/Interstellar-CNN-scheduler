...
class TestOptimizer(unittest.TestCase):
    ...
    def test_alex_conv2(self):
        ...
        access_cost_list = [1, 6, 200] 
        static_cost_list = [0, 0, 0]  
        para_count_list = [140, 1, 1] 

        # {loop: [[order, blocking, partitioning],[],...]}
        #schedule_hint = {cm.le.FX: [[0, 5, 1], None, None], cm.le.IC: [[1, 24, 1], None, None],
        #                 cm.le.FY: [[2, 1, 5], None, None], cm.le.OY: [[3, 1, 28], None, None],
        #                 cm.le.OX: [[5, 1, 1], None, None], cm.le.OC: [[4, 1, 1], None, None],
        #                 cm.le.ON: [[6, 1, 1], None, None]}

        schedule_hint = {cm.le.FX: [[0, 5, 1], None, None], 
                         cm.le.FY: [[2, 1, 5], None, None], cm.le.OY: [[3, 1, 28], None, None]}
    ...
    def test_alex_conv3(self):
        ...
        access_cost_list = [1, 6, 200] 
        static_cost_list = [0, 0, 0]  
        para_count_list = [168, 1, 1] 

        # {loop: [[order, blocking, partitioning],[],...]}
        #schedule_hint = {cm.le.FX: [[0, 3, 1], None, None], cm.le.IC: [[1, 4, 1], None, None],
    ...
    def test_vgg_conv2(self):
        ...
        schedule_hint = {cm.le.FX: [[0, 3, 1], None, None], 
                         cm.le.FY: [[2, 1, 3], None, None], cm.le.OY: [[3, None, 56], None, None]}
        ...
        level2 = cm.cost_model.get_level_cost(resource, opt_result[1], layer, 2)
        level00 = cm.cost_model.get_array_and_curr_level_cost(resource, opt_result[1], layer, 1) - level1
        print "level energy:", level0, level00, level1, level2
        cm.utils.print_loop_nest(opt_result[1]) 

        schedule_hint = {cm.le.FX: [[0, 3, 1], None, None], cm.le.OC: [[1, None, 4], None, None],
                         cm.le.FY: [[2, 1, 3], None, None], cm.le.OY: [[3, 1, 14], None, None]}
        ...
        schedule_hint = {cm.le.FX: [[0, 3, 1], None, None], cm.le.IC: [[1, None, 4], None, None],
                         cm.le.FY: [[2, 1, 3], None, None], cm.le.OY: [[3, 1, 14], None, None]}
    ...
    def test_vgg_conv12(self):
        ...
        schedule_hint = {cm.le.FX: [[0, 3, 1], None, None], cm.le.IC: [[1, None, 2], None, None],
                         cm.le.OC: [[2, None, 2], None, None],
                         cm.le.FY: [[3, 1, 3], None, None], cm.le.OY: [[4, 1, 14], None, None]}
    ...
    def test_alex_fc2(self):
        ...
        schedule_hint = {cm.le.OC: [[3, None, 16], None, None], 
                         cm.le.IC: [[4, None, 16], None, None]}
