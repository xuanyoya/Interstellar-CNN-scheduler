...
class TestOptimizer(unittest.TestCase):
    ...
    def test_conv3(self):
        ...
        # {loop: [[order, blocking, partitioning],[],...]}
        schedule_hint = {cm.le.FX: [[0, 3, 1], None, None], cm.le.IC: [[3, 1, 16], None, None],
                         cm.le.FY: [[1, 3, 1], None, None], cm.le.OY: [[5, 1, 1], None, None],
                         cm.le.OX: [[2, 13, 1], None, None], cm.le.OC: [[4, 4, 16], None, None],
                         cm.le.ON: [[6, 1, 1], None, None]}
